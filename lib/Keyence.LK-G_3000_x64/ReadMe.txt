...
(2) File and folder configuration
  ...
  LkIF.DLL          -  The main DLL program. 
  LkIF.lib			-  A lib file used to link LkIF.
  KeyUsbDrv.dll		-  DLL needed to Communicate with USB.
  LkIF.H            -  Header file when using this software from VC 
  HelpFiles folder  -  Reference of the DLL. 
                       Separate files are prepared for each function. All of the
                       references can be browsed by opening the ReadMe.htm file. 


(3) For the USB driver, install the USB driver of the LK-Navigator. 
