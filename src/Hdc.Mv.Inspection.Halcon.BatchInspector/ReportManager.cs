...
//                    writer.WriteField("");
                                                                   ...
                                                                   string dir, string suffix = null)
        {
            ...
            SaveDefectResultsToCsvGroupByWorkpieceInner(taskList, fileFullName);
        }

        private static void SaveDefectResultsToCsvGroupByWorkpieceInner(IList<IList<DefectResult>> taskList, string fileFullName)
        {
            using (var csvWriterContainer = new CsvWriterContainer(fileFullName))
            {
                var writer = csvWriterContainer.CsvWriter;
