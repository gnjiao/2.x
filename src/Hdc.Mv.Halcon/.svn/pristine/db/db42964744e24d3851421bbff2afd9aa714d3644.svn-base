...
//                      .SaveToJpeg("_EnhanceEdgeArea_Domain.jpg");
        ...
        public static double GetMeanGrayValueUsingIntensity(this HImage image, HRegion region)
        {
            double dev;
            double mean = image.Intensity(region, out dev);
            return mean;
        }

        public static double GetMeanGrayValueUsingIntensityOfDomain(this HImage image)
        {
            var domain = image.GetDomain();
            return image.GetMeanGrayValueUsingIntensity(domain);
        }

        public static double GetMeanGrayValueUsingIntensityOfFullDomain(this HImage image)
        {
            var region =  image.GetFullDomainUsingImageSizeInt32();

            return image.GetMeanGrayValueUsingIntensity(region);
        }

        public static HRegion GetFullDomainUsingImageSizeInt32(this HImage image)
        {
            var size = image.GetImageSizeInt32();

            HRegion region = new HRegion();
            region.GenRectangle1((double)0,0, size.Height-1, size.Width-1);
            return region;
        }

        public static SizeInt32 GetImageSizeInt32(this HImage image)
        {
            int width, height;
        ...
        public static HImage ReadImage(this string fileName)
        {
