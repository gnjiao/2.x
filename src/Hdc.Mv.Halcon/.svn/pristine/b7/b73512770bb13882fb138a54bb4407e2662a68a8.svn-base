...
//                Index = index
            ...
            if (definition.RelativeCenterCircleExtractor != null)
            {
                var relativeCircle = definition.RelativeCenterCircleExtractor.FindCircle(image, 
                    definition.CenterX, 
                    definition.CenterY, 
                    definition.InnerRadius, 
                    definition.OuterRadius);
                definition.CenterX = relativeCircle.CenterX;
                definition.CenterY = relativeCircle.CenterY;
            }
            ...
            if (domain.Area < 0.000001)
            {
                ...
                Debug.WriteLine("CircleInspector.SearchCircle() not found: " + definition.Name);
