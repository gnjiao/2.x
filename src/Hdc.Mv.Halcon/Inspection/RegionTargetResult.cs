...
namespace Hdc.Mv.Inspection
{
    public class RegionTargetResult
    {
        ...
        public Circle RelativeRegion { get; set; }
        ...
        double CenterRow
        {
            ...
            {
                double row, column;
                TargetRegion.AreaCenter(out row, out column);
                return row;
            }
        }
        public double CenterX => CenterRow;
        public double CenterXInWorld => CenterRow.ToMillimeterFromPixel(Definition.PixelCellSideLengthInMillimeter);
        public double RelativeCenterX => RelativeRegion.CenterX;
        ...
        public double CenterY => CenterColumn;
        public double CenterYInWorld => CenterColumn.ToMillimeterFromPixel(Definition.PixelCellSideLengthInMillimeter);
        public double RelativeCenterY => RelativeRegion.CenterY;
