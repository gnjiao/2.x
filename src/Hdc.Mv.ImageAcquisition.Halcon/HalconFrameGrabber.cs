...
{
    [Obsolete("HalconFrameGrabber has some bugs when use ImageInfo. Use HalconFrameGrabber2 instead.")]
    [Serializable]
    [ContentProperty("ParamEntries")]
    public class HalconFrameGrabber : IFrameGrabber, IDisposable
    {
        ...
        public IObservable<GrabInfo> GrabStateChangedEvent => _grabStateChangedEvent;
