...
namespace Hdc.Mv
{
    ...
    public class Line
    {
        ...
        public double Row1 => Y1;
        public double Column1 => X1;
        public double Row2 => Y2;
        public double Column2 => X2;
        ...
        public bool IsPoint => Math.Abs(X1 - X2) < 0.00000001 && Math.Abs(Y1 - Y2) < 0.00000001;
    }
}