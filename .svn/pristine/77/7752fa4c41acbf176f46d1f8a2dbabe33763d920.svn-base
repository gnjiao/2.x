...
namespace EzioDll
{
    ...
    public class clsPrinterConfig
    {
        ...
        /// <summary>
        /// ref: EZPL_programmer_manual_en.pdf, page 10, ^Qx,y - Label length
        /// </summary>
        /// <param name="nMode"></param>
        /// <param name="nLabelHeight"></param>
        /// <param name="nGapFeed"></param>
        ...
        /// x = 0, disable the cutting.
        /// x = 1 ~ 32767, number of label per cut.
        /// </summary>
        /// <param name="labelsPerCut"></param>
        public void LabelsPerCut(int labelsPerCut)
        {
            EZioApi.sendcommand("^D" + labelsPerCut.ToString());
        }
        ...
        /// same as "Tear-Off Position" in GoLabel
        /// </summary>
        /// <param name="stopPositionSetting"></param>
        public void StopPositionSetting(int stopPositionSetting)
        {
            EZioApi.sendcommand("^E" + stopPositionSetting.ToString());
        }

        public void PrintingMode(EzioDll.PrintingMode printingMode)
        {
            if (printingMode == EzioDll.PrintingMode.DirectThermal)
                EZioApi.sendcommand("^AD");

            if (printingMode == EzioDll.PrintingMode.ThermalTransfer)
                EZioApi.sendcommand("^AT");
        }
    }
